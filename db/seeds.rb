...
Image.create!(url: 'diablo_klm5ub.jpg',
              adventure_id: 8)
Image.create!(url: 'esalen_mwu3fp.jpg',
              adventure_id: 9)
Image.create!(url: 'mthood_wvpedz.jpg',
              adventure_id: 10)
Image.create!(url: 'zion_vfkap0.jpg',
              adventure_id: 11)
Image.create!(url: 'jefferson_cz4zw3.jpg',
              adventure_id: 12)
Image.create!(url: 'Lost_Coast_Trail_jjfodm.jpg',
              adventure_id: 13)
Image.create!(url: 'bryce_ohwvsn.jpg',
              adventure_id: 14)
Image.create!(url: 'goatrocks_co4ppx.jpg',
              adventure_id: 15)
Image.create!(url: 'tunnelfalls_atayrk.jpg',
              adventure_id: 16)
Image.create!(url: 'oregondesert_bxewgk.jpg',
              adventure_id: 17)
Image.create!(url: 'craterlake_cwrnpy.jpg',
              adventure_id: 18)
